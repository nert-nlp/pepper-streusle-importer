 ...
 * {@link StreusleImporter} class. Feel free to adapt and enhance this test class
 ...
 * @author Luke Gessler
 */
public class StreusleImporterTest extends PepperImporterTest {
	/**
	...
	@Before
	public void setUp() {
		setFixture(new StreusleImporter());
	...
	public void test_DummyImplementation() {
		...
		//getFixture().getCorpusDesc().setCorpusPath(getTempURI("StreusleImporter"));
