 ...
 */
//@formatter:off
@Component(name = "StreusleExporterComponent", factory = "PepperExporterComponentFactory")
//@formatter:on
public class StreusleExporter extends PepperExporterImpl implements PepperExporter {
	// =================================================== mandatory
	// ===================================================
	/**
	 ...
	 * module unique.
	 */
	public StreusleExporter() {
		super();
		setName("StreusleExporter");
	 ...
	 * In this dummy implementation an instance of {@link StreusleMapper} is
	 * created and its location to where the document-structure should be
	 * exported to is set.
	 */
	@Override
	public PepperMapper createPepperMapper(Identifier Identifier) {
		PepperMapper mapper = new StreusleMapper();
		mapper.setResourceURI(getIdentifier2ResourceTable().get(Identifier));
		return (mapper);
	}

	public static class StreusleMapper extends PepperMapperImpl {
		/**
