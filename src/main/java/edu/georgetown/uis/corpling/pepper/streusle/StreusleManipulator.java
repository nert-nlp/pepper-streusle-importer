 ...
 * @author Luke Gessler
 */
@Component(name = "StreusleManipulatorComponent", factory = "PepperManipulatorComponentFactory")
public class StreusleManipulator extends PepperManipulatorImpl {
	// =================================================== mandatory
	// ===================================================
	/**
	 ...
	 * module unique.
	 */
	public StreusleManipulator() {
		super();
		setName("StreusleManipulator");
	 ...
	 */
	public static class StreusleMapper extends PepperMapperImpl implements GraphTraverseHandler {
		/**
		...
		public DOCUMENT_STATUS mapSDocument() {
			...
			// depth-first order top down. The id 'StreusleTraversal' is used for
			...
			getDocument().getDocumentGraph().traverse(roots, GRAPH_TRAVERSE_TYPE.TOP_DOWN_DEPTH_FIRST, "StreusleTraversal", this);
