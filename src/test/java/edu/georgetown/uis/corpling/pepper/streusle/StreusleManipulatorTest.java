 ...
 * {@link StreusleManipulator} class. Feel free to adapt and enhance this test
 ...
 * @author Luke Gessler
 */
public class StreusleManipulatorTest extends PepperManipulatorTest {
	/**
	...
	@Before
	public void setUp() {
		setFixture(new StreusleManipulator());
	}
